...
APPNAME=mtb-example-btstack-freertos-le-ead-advertiser
...
#DEFINES+=LINK_KEY_DUMP
#_MTB_RECIPE_OPENOCD_CUSTOM_COMMAND+=adapter serial 1607072100172400;
...
CFLAGS+= -Wno-stringop-overread -Wno-unused-variable -Wno-unused-function -Wno-unused-but-set-variable
CFLAGS+= -Wno-format
else
ifeq ($(TOOLCHAIN), ARM)
CFLAGS+= -Wno-format
